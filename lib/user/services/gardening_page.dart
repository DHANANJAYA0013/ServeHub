...
class _GardeningPageState extends State<GardeningPage> {
  ...
  final List<String> imageUrls = [
    'images/serviceimages/gardening1.jpg',
    'images/serviceimages/gardening2.jpg',
    'images/serviceimages/gardening3.jpg',
    'images/serviceimages/gardening4.jpeg',
  ];
  ...
  void _addToCart() {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(content: Text("Gardening service added to cart")),
    );
  }
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              "Professional gardening services including lawn mowing, trimming, planting, and maintenance.",
